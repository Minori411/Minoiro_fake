...
$(function () {
  $(document).on("change", ".preview-uploader", function () {
    var elem = this; //操作された要素を取得

    var fileReader = new FileReader(); //ファイルを読み取るオブジェクトを生成

    fileReader.readAsDataURL(elem.files[0]); //ファイルを読み取る

    fileReader.onload = function () {
      //ファイル読み取りが完了したら
      var imgTag = "<img src='".concat(fileReader.result, "'>"); //img要素を生成
...
/******/ });
//# sourceMappingURL=preview-c91e3be7ffa1fd5c7886.js.map